  ...
  const faqItems = [
    {
      ...
      answer:
        '생성된 단축 URL은 영구적으로 유지됩니다. 별도의 만료 기간은 없으므로 안심하고 사용하세요.',
    },
    {
      question: '단축 URL을 삭제하려면 어떻게 하나요?',
      answer:
        '현재 저희 서비스는 사용자 등록 기능을 제공하지 않으므로, 개별적으로 생성된 URL을 직접 삭제하는 기능은 지원하지 않습니다. 중요한 정보나 개인 정보가 포함된 링크는 사용에 주의해 주세요.',
    },
    {
        question: '서비스 이용은 정말 무료인가요?',
        answer: '네, 저희 URL 단축 서비스는 100% 무료입니다. 별도의 회원가입이나 비용 청구 없이 자유롭게 이용하실 수 있습니다.'
    },
    {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-16 text-slate-700">
      <div className="space-y-16">
        ...
        <section id='feature'>
          <h2 className="text-3xl font-bold text-center text-slate-800 mb-12">주요 특징</h2>
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm">
                ...
                <p className="text-slate-500">한 번의 클릭으로 긴 URL을 짧게 변환</p>
            </div>
            <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm">
                ...
                <p className="text-slate-500">보안을 중시한 URL 관리 시스템</p>
            </div>
            <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm">
                ...
                <p className="text-slate-500">별도의 회원가입 없이 무료로 이용</p>
            </div>
          </div>
        </section>
        ...
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <section>
                ...
                <div className="space-y-6">
                    <blockquote className="border-l-4 border-slate-300 pl-4 italic text-slate-600">“복사 한 번으로 끝나는 게 정말 편리합니다. UI도 직관적이라 마음에 들어요.”</blockquote>
                </div>
            </section>
        </div>
        ...
        <footer id="about" className="text-center text-sm text-slate-500 py-8">
            ...
            <p className="max-w-xl mx-auto mb-6">이 페이지는 누구나 쉽고 빠르게 URL을 관리할 수 있도록 돕는 무료 서비스입니다. 저희는 복잡한 절차 없이, 가장 본질적인 기능에 집중하여 최고의 사용자 경험을 제공하고자 합니다.</p>
